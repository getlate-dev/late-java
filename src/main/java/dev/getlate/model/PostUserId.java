...
@JsonDeserialize(using = PostUserId.PostUserIdDeserializer.class)
@JsonSerialize(using = PostUserId.PostUserIdSerializer.class)
public class PostUserId extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostUserId.class.getName());

    public static class PostUserIdSerializer extends StdSerializer<PostUserId> {
        public PostUserIdSerializer(Class<PostUserId> t) {
            super(t);
        }

        public PostUserIdSerializer() {
            this(null);
        }

        @Override
        public void serialize(PostUserId value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PostUserIdDeserializer extends StdDeserializer<PostUserId> {
        public PostUserIdDeserializer() {
            this(PostUserId.class);
        }

        public PostUserIdDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PostUserId deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                PostUserId ret = new PostUserId();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostUserId: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public PostUserId getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PostUserId cannot be null");
        }
    }
    ...
    public PostUserId(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PostUserId(User o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(PostUserId.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PostUserId.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be String, User");
    }
     ...
     * String, User
     *
     * @return The actual instance (String, User)
     */
    @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof User) {
        if (getActualInstance() != null) {
          joiner.add(((User)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    return null;
