 ...
 */
@JsonPropertyOrder({
  UpdateQueueSlot200Response.JSON_PROPERTY_SUCCESS,
  UpdateQueueSlot200Response.JSON_PROPERTY_SCHEDULE,
...
public class UpdateQueueSlot200Response {
  ...
  public UpdateQueueSlot200Response() { 
  }

  public UpdateQueueSlot200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public UpdateQueueSlot200Response schedule(@javax.annotation.Nullable QueueSchedule schedule) {
  ...
  public UpdateQueueSlot200Response nextSlots(@javax.annotation.Nullable List<OffsetDateTime> nextSlots) {
    this.nextSlots = nextSlots;
    return this;
  }

  public UpdateQueueSlot200Response addNextSlotsItem(OffsetDateTime nextSlotsItem) {
  ...
  public UpdateQueueSlot200Response reshuffledCount(@javax.annotation.Nullable Integer reshuffledCount) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RESHUFFLED_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Integer getReshuffledCount() {
    return reshuffledCount;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RESHUFFLED_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReshuffledCount(@javax.annotation.Nullable Integer reshuffledCount) {
    this.reshuffledCount = reshuffledCount;
  }


  /**
   * Return true if this updateQueueSlot_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateQueueSlot200Response updateQueueSlot200Response = (UpdateQueueSlot200Response) o;
    return Objects.equals(this.success, updateQueueSlot200Response.success) &&
        Objects.equals(this.schedule, updateQueueSlot200Response.schedule) &&
        Objects.equals(this.nextSlots, updateQueueSlot200Response.nextSlots) &&
        Objects.equals(this.reshuffledCount, updateQueueSlot200Response.reshuffledCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateQueueSlot200Response {\n");
