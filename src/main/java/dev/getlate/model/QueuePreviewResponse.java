...
public class QueuePreviewResponse {
  ...
  public QueuePreviewResponse() { 
  }

  public QueuePreviewResponse profileId(@javax.annotation.Nullable String profileId) {
  ...
  public QueuePreviewResponse count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public QueuePreviewResponse slots(@javax.annotation.Nullable List<OffsetDateTime> slots) {
    this.slots = slots;
    return this;
  }

  public QueuePreviewResponse addSlotsItem(OffsetDateTime slotsItem) {
    if (this.slots == null) {
  ...
  /**
   * Return true if this QueuePreviewResponse object is equal to o.
   */
  @Override
