...
public class QueueUpdateResponse {
  ...
  public QueueUpdateResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public QueueUpdateResponse schedule(@javax.annotation.Nullable QueueSchedule schedule) {
  ...
  public QueueUpdateResponse nextSlots(@javax.annotation.Nullable List<OffsetDateTime> nextSlots) {
    this.nextSlots = nextSlots;
    return this;
  }

  public QueueUpdateResponse addNextSlotsItem(OffsetDateTime nextSlotsItem) {
  ...
  public QueueUpdateResponse reshuffledCount(@javax.annotation.Nullable Integer reshuffledCount) {
  ...
  public boolean equals(Object o) {
    ...
    QueueUpdateResponse queueUpdateResponse = (QueueUpdateResponse) o;
