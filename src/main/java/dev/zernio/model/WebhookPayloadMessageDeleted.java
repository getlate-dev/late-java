...
public class WebhookPayloadMessageDeleted {
  ...
  public WebhookPayloadMessageDeleted message(@javax.annotation.Nonnull WebhookPayloadMessageMessage message) {
  ...
  public WebhookPayloadMessageDeleted conversation(@javax.annotation.Nonnull WebhookPayloadMessageConversation conversation) {
  ...
  public WebhookPayloadMessageDeleted account(@javax.annotation.Nonnull WebhookPayloadMessageAccount account) {
