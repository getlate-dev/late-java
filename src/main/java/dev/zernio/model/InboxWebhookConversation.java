 ...
 */
@JsonPropertyOrder({
  InboxWebhookConversation.JSON_PROPERTY_ID,
  InboxWebhookConversation.JSON_PROPERTY_PLATFORM_CONVERSATION_ID,
  InboxWebhookConversation.JSON_PROPERTY_PARTICIPANT_ID,
...
public class InboxWebhookConversation {
  ...
  public InboxWebhookConversation id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public InboxWebhookConversation platformConversationId(@javax.annotation.Nonnull String platformConversationId) {
  ...
  public InboxWebhookConversation participantId(@javax.annotation.Nullable String participantId) {
  ...
  public InboxWebhookConversation participantName(@javax.annotation.Nullable String participantName) {
  ...
  public InboxWebhookConversation participantUsername(@javax.annotation.Nullable String participantUsername) {
  ...
  public InboxWebhookConversation participantPicture(@javax.annotation.Nullable String participantPicture) {
  ...
  public InboxWebhookConversation status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InboxWebhookConversation inboxWebhookConversation = (InboxWebhookConversation) o;
    return Objects.equals(this.id, inboxWebhookConversation.id) &&
        Objects.equals(this.platformConversationId, inboxWebhookConversation.platformConversationId) &&
        Objects.equals(this.participantId, inboxWebhookConversation.participantId) &&
