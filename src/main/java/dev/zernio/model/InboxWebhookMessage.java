...
import dev.zernio.model.InboxWebhookMessageSender;
 ...
 */
@JsonPropertyOrder({
  InboxWebhookMessage.JSON_PROPERTY_ID,
  InboxWebhookMessage.JSON_PROPERTY_CONVERSATION_ID,
  InboxWebhookMessage.JSON_PROPERTY_PLATFORM,
  InboxWebhookMessage.JSON_PROPERTY_PLATFORM_MESSAGE_ID,
  InboxWebhookMessage.JSON_PROPERTY_DIRECTION,
  InboxWebhookMessage.JSON_PROPERTY_TEXT,
  InboxWebhookMessage.JSON_PROPERTY_ATTACHMENTS,
  InboxWebhookMessage.JSON_PROPERTY_SENDER,
...
public class InboxWebhookMessage {
  ...
  @javax.annotation.Nonnull
  private InboxWebhookMessageSender sender;
  ...
  public InboxWebhookMessage() { 
  }

  public InboxWebhookMessage id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public InboxWebhookMessage conversationId(@javax.annotation.Nonnull String conversationId) {
  ...
  public InboxWebhookMessage platform(@javax.annotation.Nonnull PlatformEnum platform) {
  ...
  public InboxWebhookMessage platformMessageId(@javax.annotation.Nonnull String platformMessageId) {
  ...
  public InboxWebhookMessage direction(@javax.annotation.Nonnull DirectionEnum direction) {
  ...
  public InboxWebhookMessage attachments(@javax.annotation.Nonnull List<InboxWebhookMessageAttachmentsInner> attachments) {
    this.attachments = attachments;
    return this;
  }

  public InboxWebhookMessage addAttachmentsItem(InboxWebhookMessageAttachmentsInner attachmentsItem) {
  ...
  public InboxWebhookMessage sender(@javax.annotation.Nonnull InboxWebhookMessageSender sender) {
    this.sender = sender;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public InboxWebhookMessageSender getSender() {
    return sender;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SENDER, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSender(@javax.annotation.Nonnull InboxWebhookMessageSender sender) {
    this.sender = sender;
  }


  public InboxWebhookMessage sentAt(@javax.annotation.Nonnull OffsetDateTime sentAt) {
    this.sentAt = sentAt;
    return this;
  }
  ...
  public InboxWebhookMessage isRead(@javax.annotation.Nonnull Boolean isRead) {
    this.isRead = isRead;
    return this;
  }
  ...
  /**
   * Return true if this InboxWebhookMessage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InboxWebhookMessage inboxWebhookMessage = (InboxWebhookMessage) o;
    return Objects.equals(this.id, inboxWebhookMessage.id) &&
        Objects.equals(this.conversationId, inboxWebhookMessage.conversationId) &&
        Objects.equals(this.platform, inboxWebhookMessage.platform) &&
        Objects.equals(this.platformMessageId, inboxWebhookMessage.platformMessageId) &&
        Objects.equals(this.direction, inboxWebhookMessage.direction) &&
        Objects.equals(this.text, inboxWebhookMessage.text) &&
        Objects.equals(this.attachments, inboxWebhookMessage.attachments) &&
        Objects.equals(this.sender, inboxWebhookMessage.sender) &&
        Objects.equals(this.sentAt, inboxWebhookMessage.sentAt) &&
        Objects.equals(this.isRead, inboxWebhookMessage.isRead);
  }
