 ...
 */
@JsonPropertyOrder({
  GetContact200ResponseContact.JSON_PROPERTY_ID,
  GetContact200ResponseContact.JSON_PROPERTY_NAME,
  GetContact200ResponseContact.JSON_PROPERTY_EMAIL,
  GetContact200ResponseContact.JSON_PROPERTY_COMPANY,
  GetContact200ResponseContact.JSON_PROPERTY_AVATAR_URL,
...
public class GetContact200ResponseContact {
  ...
  public GetContact200ResponseContact() { 
  }

  public GetContact200ResponseContact id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GetContact200ResponseContact name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GetContact200ResponseContact email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public GetContact200ResponseContact company(@javax.annotation.Nullable String company) {
  ...
  public GetContact200ResponseContact avatarUrl(@javax.annotation.Nullable String avatarUrl) {
  ...
  public GetContact200ResponseContact tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public GetContact200ResponseContact addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public GetContact200ResponseContact isSubscribed(@javax.annotation.Nullable Boolean isSubscribed) {
  ...
  public GetContact200ResponseContact isBlocked(@javax.annotation.Nullable Boolean isBlocked) {
  ...
  public GetContact200ResponseContact notes(@javax.annotation.Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public GetContact200ResponseContact conversationIds(@javax.annotation.Nullable List<String> conversationIds) {
    this.conversationIds = conversationIds;
    return this;
  }

  public GetContact200ResponseContact addConversationIdsItem(String conversationIdsItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONVERSATION_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONVERSATION_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversationIds(@javax.annotation.Nullable List<String> conversationIds) {
    this.conversationIds = conversationIds;
  }


  public GetContact200ResponseContact createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public GetContact200ResponseContact updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  /**
   * Return true if this getContact_200_response_contact object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetContact200ResponseContact getContact200ResponseContact = (GetContact200ResponseContact) o;
    return Objects.equals(this.id, getContact200ResponseContact.id) &&
        Objects.equals(this.name, getContact200ResponseContact.name) &&
        Objects.equals(this.email, getContact200ResponseContact.email) &&
        Objects.equals(this.company, getContact200ResponseContact.company) &&
        Objects.equals(this.avatarUrl, getContact200ResponseContact.avatarUrl) &&
        ...
        Objects.equals(this.createdAt, getContact200ResponseContact.createdAt) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `conversationIds` to the URL query string
    if (getConversationIds() != null) {
      for (int i = 0; i < getConversationIds().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sconversationIds%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getConversationIds().get(i)))));
      }
    }
