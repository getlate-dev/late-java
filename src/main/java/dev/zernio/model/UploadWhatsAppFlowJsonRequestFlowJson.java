...
public class UploadWhatsAppFlowJsonRequestFlowJson extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UploadWhatsAppFlowJsonRequestFlowJson.class.getName());

    public static class UploadWhatsAppFlowJsonRequestFlowJsonSerializer extends StdSerializer<UploadWhatsAppFlowJsonRequestFlowJson> {
        public UploadWhatsAppFlowJsonRequestFlowJsonSerializer(Class<UploadWhatsAppFlowJsonRequestFlowJson> t) {
            super(t);
        }

        public UploadWhatsAppFlowJsonRequestFlowJsonSerializer() {
            this(null);
        }

        @Override
        public void serialize(UploadWhatsAppFlowJsonRequestFlowJson value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UploadWhatsAppFlowJsonRequestFlowJsonDeserializer extends StdDeserializer<UploadWhatsAppFlowJsonRequestFlowJson> {
        public UploadWhatsAppFlowJsonRequestFlowJsonDeserializer() {
            this(UploadWhatsAppFlowJsonRequestFlowJson.class);
        }

        public UploadWhatsAppFlowJsonRequestFlowJsonDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public UploadWhatsAppFlowJsonRequestFlowJson deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                UploadWhatsAppFlowJsonRequestFlowJson ret = new UploadWhatsAppFlowJsonRequestFlowJson();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UploadWhatsAppFlowJsonRequestFlowJson: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public UploadWhatsAppFlowJsonRequestFlowJson getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "UploadWhatsAppFlowJsonRequestFlowJson cannot be null");
        }
    }
    ...
    public UploadWhatsAppFlowJsonRequestFlowJson() {
        super("oneOf", Boolean.FALSE);
    }

    public UploadWhatsAppFlowJsonRequestFlowJson(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public UploadWhatsAppFlowJsonRequestFlowJson(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(UploadWhatsAppFlowJsonRequestFlowJson.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return UploadWhatsAppFlowJsonRequestFlowJson.schemas;
    }
