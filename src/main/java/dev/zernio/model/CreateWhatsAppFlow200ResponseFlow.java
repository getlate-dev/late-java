...
public class CreateWhatsAppFlow200ResponseFlow {
  ...
  public CreateWhatsAppFlow200ResponseFlow id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateWhatsAppFlow200ResponseFlow name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateWhatsAppFlow200ResponseFlow status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public CreateWhatsAppFlow200ResponseFlow categories(@javax.annotation.Nullable List<String> categories) {
    this.categories = categories;
    return this;
  }

  public CreateWhatsAppFlow200ResponseFlow addCategoriesItem(String categoriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWhatsAppFlow200ResponseFlow createWhatsAppFlow200ResponseFlow = (CreateWhatsAppFlow200ResponseFlow) o;
