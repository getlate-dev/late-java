 ...
 */
@JsonPropertyOrder({
  UpdateLeadFormRequest.JSON_PROPERTY_ACCOUNT_ID,
  UpdateLeadFormRequest.JSON_PROPERTY_STATUS
})
...
public class UpdateLeadFormRequest {
  ...
  public UpdateLeadFormRequest() { 
  }

  public UpdateLeadFormRequest accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public UpdateLeadFormRequest status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   * Return true if this updateLeadForm_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateLeadFormRequest updateLeadFormRequest = (UpdateLeadFormRequest) o;
    return Objects.equals(this.accountId, updateLeadFormRequest.accountId) &&
        Objects.equals(this.status, updateLeadFormRequest.status);
  }
