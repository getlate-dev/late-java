...
|**callToAction** | [**CallToActionEnum**](#CallToActionEnum) | Required on legacy + attach shapes for Meta. Honoured on TikTok too — passes through to the Spark Ad creative&#39;s &#x60;call_to_action&#x60;. Ignored by other platforms. Ignored on Meta when &#x60;leadGenFormId&#x60; is set — lead ads force CTA type to SIGN_UP. |  [optional] |
